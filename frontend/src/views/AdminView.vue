<template>
    <div className='w-full bg-gray-200'>
        ...
        <div class="lg:grid grid-cols-12 h-full">
            <div :class="{ 'hidden lg:block': !isSidebarVisible }" class="col-span-3 fixed z-30 min-h-[100vh] lg:h-full  lg:static lg:z-0 bg-[#070808] text-white shadow-md">
                <div class="p-2">
                    ...
                    <div class="uppercase font-bold">
                        <ul>
                            <li class="block group">
                                <p class="flex justify-between py-2 pl-20 hover:bg-slate-300 hover:text-black cursor-pointer">
                                    Sản phẩm
                                    <VueIcon type="mdi" :path="mdiChevronDown"/>
                                </p>
                                <div class="hidden group-hover:flex flex-col text-white pl-24 text-xs">
                                    <router-link :to="{name:'adminProduct',}" class="p-2 " >Danh sách sản phẩm</router-link>
                                    <router-link :to="{name:'adminProduct',}" class="p-2 ">Danh sách ảnh</router-link>
                                </div>
                            </li>
                ...
                <div class=" p-2">
                    <div class="h-10 flex justify-between">
                        <div class=" p-2 flex justify-between lg:justify-end items-center">
                            ...
                            <h1 class="font-bold text-xl">Trang quản trị</h1>
                        </div>   
