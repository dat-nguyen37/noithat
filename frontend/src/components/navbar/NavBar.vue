        ...
        <div class="h-16 flex justify-between px-5 md:px-0 md:justify-around items-center gap-2">
            ...
            <div class="flex items-center gap-5">
                        ...
                        <div class="overflow-hidden">
                            <div class="flex w-[100%] transform transition-transform duration-500 ease-out" :style="{ transform: recoverPanel ? 'translateX(-100%)' : 'translateX(0)' }">
                                <div id="login-panel" class="min-w-full md:min-w-[24rem] flex flex-col gap-2 p-2">
                                    <h1 class="text-xl uppercase">Đăng nhập tài khoản</h1>
                                    <p class="text-gray-400">Nhập email và mật khẩu của bạn:</p>
                                    <input type="email" placeholder="Nhập email hoặc số điện thoại" class="outline-none border p-2">
                                    <input type="password" placeholder="Mật khẩu" class="outline-none border p-2">
                                    <span class="text-gray-400">Website được bảo vệ bởi reCAPTCHA và <a href="https://policies.google.com/privacy" class="text-blue-500">Chính sách bảo mật</a> và <a href="https://policies.google.com/terms" class="text-blue-500">Điều khoản dịch vụ</a> của Google.</span>
                                    <button class="bg-black text-white font-bold py-2">Đăng nhập</button>
                                    <p class="text-gray-400">Khách hàng mới? <a href="" class="text-blue-500">Tạo tài khoản</a></p>
                                    <p class="text-gray-400">Quên mật khẩu? <span @click="openRecoverPanel" class="text-blue-500 cursor-pointer">Khôi phục mật khẩu</span></p>
                                </div>
                                <div id="recover-panel" class="min-w-full md:min-w-[24rem] flex flex-col gap-2 p-2">
                                    <h1 class="text-xl uppercase">Khôi phục mật khẩu</h1>
                                    <div class="flex gap-2">
                                        ...
                                        <label for="emailCheck">Khôi phục bằng email</label>
                                    </div>
                                    <div class="flex gap-2">
                                        ...
                                        <label for="phoneCheck">Khôi phục bằng số điện thoại</label>
                                    </div>
                                    <div v-if="recoverLogin==='email'" class="flex flex-col gap-2">
                                        <input type="email" placeholder="Email" class="outline-none border p-2">
                                        <span class="text-gray-400">Website được bảo vệ bởi reCAPTCHA và <a href="https://policies.google.com/privacy" class="text-blue-500">Chính sách bảo mật</a> và <a href="https://policies.google.com/terms" class="text-blue-500">Điều khoản dịch vụ</a> của Google.</span>
                                        <button class="bg-black text-white font-bold py-2">Khôi phục</button>
                                        <p class="text-gray-400">Bạn đã nhớ mật khẩu? <span @click="openRecoverPanel" class="text-blue-500 cursor-pointer">Trở về đăng nhập</span></p>
                                    </div>
                                    <div v-if="recoverLogin==='phone'" class="flex flex-col gap-2">
                                        <input type="phone" placeholder="Nhập số điện thoại" class="outline-none border p-2">
                                        <button class="bg-black text-white font-bold py-2">Gửi mã xác nhận</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class=" flex items-center justify-center gap-1 relative">
                    ...
                    <p @click="openCart" class="hidden lg:flex cursor-pointer">Giỏ hàng</p>
                    <div id="cart" :class="cart ?'flex':'hidden'" class="absolute flex-col  top-14 p-2 text-sm w-screen -right-[70px] md:w-[24rem] md:-right-20 z-20 bg-white text-center shadow-[0px_0px_2px_2px_rgba(0,0,0,0.3)]">
                        <p class="uppercase font-bold text-gray-500 py-2 border-b w-full">Giỏ hàng</p>
                        <div>
                        ...
                        <div class="py-2 flex flex-col gap-2">
                            ...
                            <div class="flex gap-2 justify-between text-white text-sm uppercase">
                                <a href="" class="w-1/2 bg-gray-600 py-2">Xem giỏ hàng</a>
                                <a href="" class="w-1/2 bg-blue-800 py-2">Thanh toán</a>
                            </div>
                        </div>
