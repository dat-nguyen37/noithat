    ...
    <div class="w-full">
        ...
        <div class="py-2 flex flex-col gap-2">
            <div class="flex flex-col md:w-1/2">
                ...
                <input type="Password" v-model="OldPassword" class="border outline-none p-2">
            </div>
            <div class="flex flex-col md:w-1/2">
                <label for="">Mật khẩu mới *</label>
                <input type="Password" v-model="NewPassword" class="border outline-none p-2">
            </div>
            <div class="flex flex-col md:w-1/2">
                <label for="">Xác nhận lại mật khẩu *</label>
                <input type="Password" v-model="ConfirmPassword" class="border outline-none p-2">
            </div>
...
export default{
    ...
    methods:{
        async Update(){
            // try {
            //     await axios.patch(`/Auth/update/${this.$store.state.user.id}`,{
